...
#### 1. `Pull Request` follows a guidelines and template
- `Pull Request` must follow the [pull request guidelines](./pull-request-guidelines.md) and must use proper `Pull Request Template`
- All the details of the template used by `Pull Request` are **concise**, **correct**, **complete**, and **consistent**.
...
- **Arc-i-Tech** project specific code styles are created, [Arc-i-Tech Code Style Guide](./coding-guides/)
...
#### 5. Code Logic and Functionality
...
#### 9. Final Checks Before Approval
- **Checks:** Verify `Pull Request Checks`. If any failed checks address it. 

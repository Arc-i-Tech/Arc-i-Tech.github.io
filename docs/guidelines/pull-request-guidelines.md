...
5. `Pull Request` **Title** must follow below conventions
   > **`<Type>: Short summary`** 
...
6. Link a related **issue** for this PR.
...
7. Once your PR is ready add reviewers. Reviewer must be owner/ assignee of parent **issue**
...
8. Reviewers will review th `Pull Request` and can do either of follow:
...
9.  Once you get **2** or more PR reviews **approved** and **all checks are passed** you can merge your PR.
   - You can use **Squash and merge** option to merge and close the PR.
10. Once your PR is merged, then close the **ISSUE** for which you created this PR.

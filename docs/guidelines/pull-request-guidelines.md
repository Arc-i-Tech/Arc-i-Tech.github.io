...
1. :memo: Branch name must follow the [Branch Naming convention](./branch-creation-guidelines.md). Any branch not following these convention `Pull Request` of it won't be reviewed. and cannot be accepted.
2. Commit on your branch should be as per [Commit Guidelines](./commit-guidelines.md).
3. Make sure that your PR is not a **duplicate**.
4. Follow `pull request` **template** for PR creation.
...
5. If **work is not finished** then avoid creating PR.
...
6. **Target/ base** branch for your PR must be of parent issue branch of your issue.
...
7. `Pull Request` **Title** must follow below conventions
   > **`<Type>: Short summary`** 
   - **Type** is what this PR is solving
       a. Feature
       b. Epic
       c. User-Story
       d. Task
       e. BUG
       f. Hot-Fix
   - Short summary about PR. 
8. Link a related **issue** for this PR.
...
9. Once your PR is ready add reviewers. Reviewer must be owner/ assignee of parent **issue**
   ...
   -  For any `Pull Request` add team **[Arc-i-Tech/reviewers](https://github.com/orgs/Arc-i-Tech/teams/reviewers)** <img src="images/team_reviewer.png" alt="Team Reviewer" width="25%" height="100%">  as reviewer so that members of **reviewers** team can submit their reviews.
10. Reviewers will review th `Pull Request` and can do either of follow:
...
11. Once you get **2** or more PR reviews **approved** and **all checks are passed** you can merge your PR.
   - You can use **Squash and merge** option to merge and close the PR.
12. Once your PR is merged, then close the **ISSUE** for which you created this PR.

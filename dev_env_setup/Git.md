...
4. Select destination folder and then click **Next**
...
6. Select component to install and click **Next**. _(Mostly default selection is sufficient)_
   
   ![4](https://github.com/user-attachments/assets/4a08c283-4eab-4092-92b3-44a89a1f2bdb)
   
8. On Select Start Menu Folder - 
...
9. Choose the deafult editor used by **Git** and click **Next**
